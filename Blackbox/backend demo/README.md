...
```powershell
uv run --extra test python "Blackbox/backend demo/cli.py"
```
...
```powershell
uv run --extra test python "Blackbox/backend demo/cli.py" --demo data/samples/match.dem
uv run --extra test python "Blackbox/backend demo/cli.py" --json data/private/processed/full_replays.jsonl
uv run --extra test python "Blackbox/backend demo/cli.py" --player-id t1
```

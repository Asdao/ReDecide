"""Single public entry point for Blackbox replay analysis."""
...
def load_replay_record(path: str | Path, *, record_index: int = 0) -> dict[str, Any]:
    ...
    if source.suffix.lower() == ".dem":
        ...
        from Blackbox.training.replay_extractor_adapter import parse_extractor_demo
...
def analyze_replay(
    ...
    *,
    ...
    """Analyze one replay through the deployed Blackbox model harness.

...
class DownloaderTests(unittest.TestCase):
    ...
    def test_remote_stream_yields_chunks_without_creating_a_file(self) -> None:
        ...
        with patch(
            "Blackbox.training.download_dataset.urllib.request.urlopen",
    ...
    def test_dataset_listing_uses_data_tree_and_follows_pages(self) -> None:
        ...
        with patch("Blackbox.training.download_dataset.urllib.request.urlopen", side_effect=[first, second]) as open_url:
    ...
    def test_dataset_listing_can_include_the_repository_root(self) -> None:
        ...
        with patch("Blackbox.training.download_dataset.urllib.request.urlopen", return_value=Response()) as open_url:
            self.assertEqual(

...
from Blackbox.training.stream_sidecars import select_and_stream
from Blackbox.training.train_full_replay import train as train_full_replay
from Blackbox.training.train_snapshot_model import train as train_snapshot_model
...
def train_from_stream(
    *,
    ...
    release_dir: str | Path = Path("Blackbox/model/artifacts/releases/v3"),
...
def main() -> int:
    ...
    parser.add_argument(
        "--release-dir",
        type=Path,
        default=Path("Blackbox/model/artifacts/releases/v3"),
    )

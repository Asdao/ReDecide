...
from Blackbox.training import replay_state as _replay_state
from Blackbox.training.analysis_report import (
    _coached_player,
...
from Blackbox.training.candidate_analysis import (
    CandidateModel,

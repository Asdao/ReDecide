...
export const PROCESSED_REPLAYS: readonly ProcessedReplaySummary[] = [
  {
    ...
    description: "A preprocessed 30-round replay with player-specific AI coaching, generated by the same pipeline used in the live demo.",
    map: "de_mirage",
    rounds: 30,
    players: 10,
  ...
  },
  {
    ...
    description: "A preprocessed 29-round replay with player-specific AI coaching, generated by the same pipeline used in the live demo.",
    map: "de_inferno",
    rounds: 29,
    players: 10,

...
from Noah.training.stream_sidecars import select_and_stream
from Noah.training.train_full_replay import train as train_full_replay
from Noah.training.train_snapshot_model import train as train_snapshot_model
...
def train_from_stream(
    *,
    ...
    release_dir: str | Path = Path("Noah/model/artifacts/releases/v3"),
...
def main() -> int:
    ...
    parser.add_argument(
        "--release-dir",
        type=Path,
        default=Path("Noah/model/artifacts/releases/v3"),
    )

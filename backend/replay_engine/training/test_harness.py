...
The orchestration facade lives in :mod:`backend.replay_engine.training.analysis_harness`, with
...
from backend.replay_engine.harness import analyze_replay, load_replay_record
...
def run_replay_test(
    ...
    *,
    ...
    """Compatibility wrapper for the public :func:`backend.replay_engine.analyze_replay`."""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="release bundle root (defaults to backend/replay_engine/model/artifacts/releases)",
    )
    parser.add_argument(
        "--version",
        default=None,

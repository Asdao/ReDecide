...
def _first_contact_candidates(
    ...
    *,
    ...
    from Blackbox.training.action_labeler import build_action_event_index, classify_action
...
def _win_estimator(
    ...
    *,
    ...
    try:
        ...
        release_dir = Path(__file__).resolve().parents[3] / "Blackbox" / "model" / "artifacts" / "releases"
